...
btc_civ_type_units = [
    "arg_shirt_checked_blue", 
    "arg_shirt_checked_bluegreen_texture", 
    "arg_shirt_checked_green", 
    "arg_shirt_checked_grey", 
    "arg_shirt_checked_pink", 
    "arg_shirt_checked_purple", 
    "arg_shirt_checked_tartan", 
    "arg_shirt_checked_yellow_01_texture", 
    "arg_shirt_blue_gold_watch", 
    "arg_shirt_green_gold_watch", 
    "arg_shirt_bundeswehr_gold_watch", 
    "arg_shirt_ice_grey_gold_watch", 
    "arg_shirt_olive_gold_watch", 
    "arg_shirt_orange_gold_watch", 
    "arg_shirt_skol_gold_watch", 
    "arg_shirt_white_gold_watch", 
    "arg_shirt_yellow_gold_watch", 
