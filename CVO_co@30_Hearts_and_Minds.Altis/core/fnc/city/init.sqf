...
for "_id" from 0 to (count _locations - 1) do {
    ...
    if (_type in _citiesType) then {
        ...
        if ((getMarkerPos "btc_base") inArea [_position, 1000, 1500, 0, false]) exitWith {};
        if ((getMarkerPos "btc_base_1") inArea [_position, 1000, 1500, 0, false]) exitWith {};
        if ((getMarkerPos "btc_base_2") inArea [_position, 1000, 1500, 0, false]) exitWith {};
        if ((getMarkerPos "btc_base_3") inArea [_position, 1000, 1500, 0, false]) exitWith {};
        if ((getMarkerPos "btc_base_4") inArea [_position, 1000, 1500, 0, false]) exitWith {};
        ...
        if ((getMarkerPos "btc_base_10") inArea [_position, 1000, 1500, 0, false]) exitWith {};
